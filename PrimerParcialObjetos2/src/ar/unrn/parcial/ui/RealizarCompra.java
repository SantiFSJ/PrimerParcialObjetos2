...
public class RealizarCompra {
	...
	private MandadorVentas mandaVentas;
	...
	public RealizarCompra(SistemaVentas sistVentas, SistemaFechas sistFechas, RepositorioVentas repoVentas,
			MandadorVentas mandaVentas, ArrayList<Remera> listaRemeras) {
		this.sistFechas = sistFechas;
		this.sistVentas = sistVentas;
		this.mandaVentas = mandaVentas;
	...
	private void realizarCompra() {
		if (validarComboBox()) {
			...
			try {
				sistVentas.generarVenta(sistFechas, repoVentas, mandaVentas, Integer.valueOf(txtCantidad.getText()),
